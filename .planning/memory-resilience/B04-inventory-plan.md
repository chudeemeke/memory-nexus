...
`quality-classifications.json` currently contains 266 proposed classifications and
180 explicit unclassified entries. No test driver is automatically excluded. The
actual `bun run quality:inventory` command fails on all 180 unknown tiers; the
