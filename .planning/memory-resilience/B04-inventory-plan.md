...
`quality-classifications.json` currently contains 120 proposed classifications and
326 explicit unclassified entries. No test driver is automatically excluded. The
actual `bun run quality:inventory` command fails on all 326 unknown tiers; the
