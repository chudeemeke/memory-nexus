...
`quality-classifications.json` currently contains 241 proposed classifications and
205 explicit unclassified entries. No test driver is automatically excluded. The
actual `bun run quality:inventory` command fails on all 205 unknown tiers; the
